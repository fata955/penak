...
if ($_GET["action"] === "insertData") {
    if (!empty($_POST["dataspmdetail"])) {
        ...
        if ($hal != null) {
            ...
            function insertData($koneksi, $query, $params, $types)
            {
            ...
            if ($idl == "LS") {
                ...
                $nama_pihak_ketiga  = str_replace("'", "", $dt["ls"]["header"]["nama_pihak_ketiga"]);
                $no_rek_pihak_ketiga = str_replace("'", "", $dt["ls"]["header"]["no_rek_pihak_ketiga"]);
                $nama_rek_pihak_ketiga = str_replace("'", "", $dt["ls"]["header"]["nama_rek_pihak_ketiga"]);
                $bank_pihak_ketiga  = $dt["ls"]["header"]["bank_pihak_ketiga"];
                $npwp_pihak_ketiga  = $dt["ls"]["header"]["npwp_pihak_ketiga"];
                $keterangan_spm     = str_replace("'", "", $dt["ls"]["header"]["keterangan_spm"]);
                $nilai_spm          = $dt["ls"]["header"]["nilai_spm"];
                $nomor_spp          = $dt["ls"]["header"]["nomor_spp"];
                $tanggal_spp        = $dt["ls"]["header"]["tanggal_spp"];
                $nama_pa_kpa        = str_replace("'", "", $dt["ls"]["header"]["nama_pa_kpa"]);
